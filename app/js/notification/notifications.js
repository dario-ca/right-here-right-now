...
Notifications.data = {
    ...
    POTHOLE_CITY_CHANGED: "data.POTHOLE_CITY_CHANGED",
    RAT_BITES_CHANGED: "data.RAT_BITES_CHANGED",
    ABANDONED_VEHICLES_CHANGED: "data.ABANDONED_VEHICLES_CHANGED",
    ABANDONED_VEHICLES_CITY_CHANGED: "data.ABANDONED_VEHICLES_CITY_CHANGED",
    ...
    LIGHT_OUT_SINGLE_CITY_CHANGED: "data.LIGHT_OUT_SINGLE_CITY_CHANGED",
    ...
    LIGHT_OUT_ALL_SELECTION_CHANGED: "data.LIGHT_OUT_ALL_SELECTION_CHANGED",
    LIGHT_OUT_ALL_CITY_CHANGED: "data.LIGHT_OUT_ALL_CITY_CHANGED",
    LIGHT_SELECTION_CHANGED: "data.LIGHT_SELECTION_CHANGED",
    ...
    FOOD_SELECTION_CHANGED: "data.FOOD_SELECTION_CHANGED",
    FOOD_INSPECTION_CITY_CHANGED: "data.FOOD_INSPECTION_CITY_CHANGED",
    CRIME_TYPE_CITY_CHANGED: "data.CRIME_TYPE_CITY_CHANGED",
    BAR_CHANGED: "data.BAR_CHANGED",
    BAR_SELECTION_CHANGED: "data.BAR_SELECTION_CHANGED",

    PLACE_CHANGED:"data.PLACE_CHANGED",
    PLACE_SELECTION_CHANGED:"PLACE_SELECTION_CHANGED",
